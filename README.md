...
**Backend:** Spring, Spring Boot, Java, Kotlin, Groovy, Ktor, FastAPI, NestJS, WebFlux, Feign, MapStruct, JAXB, EventBus, Temporal.io

**Data:** MongoDB, MySQL, PostgreSQL, Redis, Cassandra, Elastic/OpenSearch, Liquibase, Exposed

**Messaging & streaming:** Apache Kafka, Nats

**Cloud & ops:** Docker, k8s, OpenShift, Istio, Envoy, mTLS, nginx, Jenkins, Ansible, ProxMox, Amazon Lambda, S3, MinIO, Serverless
...
**Frontend & mobile:** React, Next.js, Svelte, TypeScript, Node.js, Android
